...
object Test {
  ...
  };import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(2549); 
 
  // Create a DB session
  implicit val session = Database.forURL("jdbc:h2:mem:play", driver = "org.h2.Driver").createSession();System.out.println("""session  : scala.slick.session.Session = """ + $show(session ));$skip(549); val res$0 = 
  ...
  };System.out.println("""res0: Seq[Int] = """ + $show(res$0));$skip(459); 
  ...
  val productsQuery: scala.slick.lifted.Query[models.Test.Products.type, models.Test.Product] =
    for( product <- Products if product.name.startsWith("B")) yield product;System.out.println("""productsQuery  : scala.slick.lifted.Query[models.Test.Products.type,models.Test.Product] = """ + $show(productsQuery ));$skip(364); val res$1 = 
  ...
  productsQuery.selectStatement: String;System.out.println("""res1: String = """ + $show(res$1));$skip(199); val res$2 = 
 
 
  // Now when you call 'list' method on the query object, only then the query is forced to be executed and its result
  // is returned as a list
 
  productsQuery.list: List[models.Test.Product];System.out.println("""res2: List[models.Test.Product] = """ + $show(res$2));$skip(986); 
  ...
  };System.out.println("""productsWithProperty  : scala.slick.lifted.Query[(models.Test.ProductProperties.type, models.Test.Products.type),(models.Test.ProductProperty, models.Test.Product)] = """ + $show(productsWithProperty ));$skip(68); val res$3 = 
 
  // Get generated SQL
  productsWithProperty.selectStatement;System.out.println("""res3: String = """ + $show(res$3));$skip(106); val res$4 = 
 
  // You could use groupBy to group results by Product
  productsWithProperty.list.groupBy( x => x._2 );System.out.println("""res4: scala.collection.immutable.Map[models.Test.Product,List[(models.Test.ProductProperty, models.Test.Product)]] = """ + $show(res$4));$skip(542); 
  ...
  };System.out.println("""productsByProperty  : scala.slick.driver.BasicQueryTemplate[String,models.Test.Product] = """ + $show(productsByProperty ));$skip(205); val res$5 = 
  ...
  productsByProperty("white").list;System.out.println("""res5: List[models.Test.Product] = """ + $show(res$5));$skip(193); 
  ...
  val productById = Products.byId(2).list;System.out.println("""productById  : List[models.Test.Product] = """ + $show(productById ))}
