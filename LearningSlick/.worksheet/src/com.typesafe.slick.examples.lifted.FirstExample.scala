...
object FirstExample {
  ...
  };import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(4756); 

  // Connect to the database and execute the following block within a session
  Database.forURL("jdbc:mysql://localhost:3306/slick", user="root", password="snow314eagle159", driver = "com.mysql.jdbc.Driver") withSession {
